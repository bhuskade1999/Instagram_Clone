...
const UserProfile = () => {
  ...
  }, [user, me, me._id, params.id, dispatch]);
            ...
            <div className="content">
              ...
              <div className="details">
                ...
                <div>
                  ...
                  >
                    <Typography variant="contained" style={{ color: "white" }}>
                      {" "}
                      Following{" "}
                    </Typography>
                  </button>
          ...
          <div className="user-requests">
            {user && (
              <Typography variant="h5">
                ...
                <span
                  style={{ color: "rgb(23, 201, 225)", fontSize: "1.3rem" }}
                >
                  {" "}
                  {user.name}{" "}
                </span>{" "}
        ...
        <div className="my-posts">
          {following ? (
            ...
            <Typography variant="h5" style={{ marginTop: "50px" }}>
              Please Follow User To View Posts
            </Typography>
          )}
        </div>
      </div>
