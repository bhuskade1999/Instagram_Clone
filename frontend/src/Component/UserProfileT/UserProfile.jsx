...
const UserProfile = () => {
   ...
   // const [tab, setTab] = useState(window.location.pathname)
    ...
    const RejectHandler = async () => {
        await dispatch(rejectsUserRequest(params.id))
        await dispatch(getUserProfile(params.id))
        //window.location.reload();
                ...
                <div className="center-side">
                    ...
                    {userRequest ?
                        <div className="user-requests">
                            ...
                            <Typography variant='h5'><PersonAddOutlinedIcon/> <span style={{ color: "rgb(23, 201, 225)", fontSize: "1.3rem" }}> {user.name} </span>  want to follow you </Typography>
